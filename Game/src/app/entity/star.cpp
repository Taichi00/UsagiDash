...
Star::Star() : Entity("star", "star", "item")
{
	...
	ParticleEmitterProperty confetti_prop = {};
	{
		...
		confetti_prop.spawn_count = 60;
		confetti_prop.spawn_rate = 60;
		...
		confetti_prop.position_easing.start = Vec3(2, 2, 2);
		...
		confetti_prop.scale_type = PROP_TYPE_PVA;
		confetti_prop.scale_pva.scale = Vec3(1.5f, 1.5f, 1.5f);
		confetti_prop.scale_pva.scale_range = Vec3(0.5f, 0.5f, 0.5f);
